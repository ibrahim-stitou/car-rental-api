...
class ReservationResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            // Options de la section « Loyer » (contrat LLD corporate)
            'insurance_included'  => $this->insurance_included,
            'replacement_vehicle_included' => $this->replacement_vehicle_included,
            'replacement_vehicle' => $this->replacement_vehicle,
            'tire_replacement'    => $this->tire_replacement,
            'all_risk_franchise_pct' => $this->all_risk_franchise_pct,
